	...
	<div class="container">
		...
		<form class="bookform-form" action="#" role="form" method="post">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-md-offset-2 col-xs-12 history-text">
				...
				<p class="text-justify">We also provide basic ground transportation for goods all over India, covering great distances and overcoming uneven terrain. We put in a lot of effort to ensure that we will never fall behind schedule Packers and Movers Guwahati.



				Our services include: relocation and movement of bulk goods and containers, and road and rail transport. Additionally, we allow the client to select groupage of other cargo and other transport solutions, such as transport of the goods in parts and whether the journey is to be covered by two different modes of transport Movers and Packers Guwahati.</p>



				<img src="images/landtransport.jpg" class="img-thumbnail" alt="packers and movers, movers and packers in guwahati">



				<p class="text-justify"><b>SOME OF OUR CAPABILITIES INCLUDE :</b>

					<br>

					* Transportation of heavy and odd dimensional cargo to any destination in India.<br>

					* Project cargo movement from inception to erection and commission.	<br>

					* Delivery to consignee destination of import cargo after custom clearance from aircargo and seaport on our own delivery trucks.<br>

					* Personal baggage trucking to passenger doorstep after clearance.<br>

					* Container transportation trailers for all inland destinations in India.<br>

					* Pickup of Export Cargo from shipper warehouse to nearest port.<br>
