	...
	<div class="container">
		...
		<div class="row">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Domestic Relocation</li>
	...
	<div class="container">
		...
		<form class="bookform-form" action="#" role="form" method="post">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-md-offset-2 col-xs-12 history-text">
				...
				<p class="text-justify">Rhino Packers & Movers Guwahati has devised convenient and brilliant ways to move its customers' households or vehicles anywhere within the territory. Movers and Packers Guwahati Our services are proficiently designed to meet the maximum customer satisfaction, and they are also rendered in such a way, so as to come out high on the expectations of our clients.</p>



				<img src="images/loading-and-nloading.jpg" class="img-thumbnail" alt="packers and movers, movers and packers in guwahati">



				<p class="text-justify">Considered as the leaders in Packing & Moving business, we are best known for offering unparalleled, plethora of efficient moving services in the domestic sector. We ensure that deviations, of any form, do not creep in and hamper our efficiency. However, in case of an unfortunate accident, packers and movers Guwahati inspite of all safety precautions undertaken, we try to take the entire responsibility of the loss thence incurred and compensate fairly.

				</p>

				<p class="text-justify">

					So, as our customer, you can be totally assured of availing the safest and faster services, which are being executed at the right time, whereby ensuring that the goods get delivered to you in the intact condition.
