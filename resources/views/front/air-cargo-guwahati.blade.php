	...
	<div class="container">
		...
		<div class="row">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Air Cargo Shifting</li>
	...
	<div class="container">
		...
		<form class="bookform-form" action="#" role="form" method="post">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-md-offset-2 col-xs-12 history-text">
				...
				<h3>Air Cargo Shifting</h3>



				<p class="text-justify">Rhino Packers & Movers Guwahati offers to our clients ,a cost effective,secure,timely and efficient solution for all airfreight shipments, to and from any point in the world. We control the entire process from ground transportation,insurance coverage arrangement,air consolidation,arrangement of cargo survey,appropriate and safe warehousing to customs documentation.Time being the essence,we ensure speed matches reliability for your shipment.</p>



				<img src="images/airfreight.jpg" class="img-thumbnail" alt="packers and movers, movers and packers in guwahati">



				<p class="text-justify">At Rhino Packers & Movers Guwahati, we believe in offering the best possible service to our clients and so we can modify our offerings to ensure that our products are tailormade to you needs. Movers and Packers Guwahati We have no qualms in saying that we can offer a perfect solution for your requirement,be it a single shipment or a multi plane chartering operation.You can bank on us to reach your freight at your designated place in the designated time.
